...
HD_PWD='C:/Users/bcurt/Documents/GitHub/32Bit_MIPS_Processor/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopModuleV2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopModuleV2.tcl -notrace
