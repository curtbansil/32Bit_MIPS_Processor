...
module TopModuleFinal(Clk, Rst, HiReg, LoReg, WB_RegWD, IF_PCOut);
...
//    BranchPredictor BP1(ID_Branch, ID_PCNext, PredictedAd);
    ...
    HazardDetectionV2 HazardDetection1(ID_Opcode, ID_Function, ID_RegRs, ID_RegRt, EX_MemRead, EX_RegRt,
...
//        EX_MemtoReg, MEM_MemtoReg);
    ...
    // Forwarding muxes
    Mux32Bit2To1 ID_ForwardA1(ID_BOutA, ID_ReadData1, WB_RegWD, ID_ForwardAControl);
    Mux32Bit2To1 ID_ForwardB1(ID_BOutB, ID_ReadData2, WB_RegWD, ID_ForwardBControl);
    
    // Branching logic
    Comparator BranchComp1(ID_Opcode, ID_RegRt, ID_ReadData1, ID_ReadData2, ID_BranchC2);
    ...
    // 32-bit outputs
    Reg32Bit IDEX_RdData1_1(EX_ReadData1, ID_BOutA, IDEX_WrEn, IDEX_Flush, Clk);
    Reg32Bit IDEX_RdData2_1(EX_ReadData2, ID_BOutB, IDEX_WrEn, IDEX_Flush, Clk);
