...
HD_PWD='C:/Users/bcurt/Documents/GitHub/32Bit_MIPS_Processor/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopModuleV2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopModuleV2.tcl
